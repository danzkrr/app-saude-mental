    ...
    if (theme == "tertiary") {
        return (
            <View style={styles.buttonContainerTertiary }>
                <Pressable style={[styles.button, {alignItems: "baseline", justifyContent: "space-around"}]} onPress={onPress}>
                    <Text style={[styles.buttonLabel, { color: 'rgb(0, 0, 0)', fontSize: 20, textDecorationLine: 'underline'}]}>{label}</Text>
                </Pressable>
            </View>
        ) 
    }
